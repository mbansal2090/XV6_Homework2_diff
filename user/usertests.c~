...
getprocstest(void){
	printf(stdout, "\n\n\n\n\n\n\n\n========================================\n");
	printf(stdout, "Welcome to getprocstest method!!!\n");
	printf(stdout, "no of processes = %d\n", getprocs());
	fork();
	printf(stdout, "no of processes = %d\n", getprocs());
	printf(stdout, "========================================\n\n\n\n\n\n\n\n\n");
}
...
setpritest(void){
	printf(stdout, "\n\n\n\n\n\n\n\n========================================\n");
	printf(stdout, "Welcome to setpritest method!!!\n");
	printf(stdout, "setting priority of process to 2, is it success = %d\n", setpri(2));
	printf(stdout, "setting priority of process to 0, is it success = %d\n", setpri(0));
	printf(stdout, "setting priority of process to 5, is it success = %d\n", setpri(5));
	printf(stdout, "========================================\n\n\n\n\n\n\n\n\n");
}
...
getpinfotest(void){
	printf(stdout, "\n\n\n\n\n\n\n\n========================================\n");
	printf(stdout, "Welcome to getpinfotest method!!!\n");
	struct pstat * ptr = (struct pstat*)malloc(sizeof(struct pstat));
	printf(stdout, "getting priority of all processes, is it success = %d\n", getpinfo(ptr));
	printf(stdout, "getting priority of all processes, is it success = %d\n", getpinfo(NULL));
	printf(stdout, "========================================\n\n\n\n\n\n\n\n\n");
}
